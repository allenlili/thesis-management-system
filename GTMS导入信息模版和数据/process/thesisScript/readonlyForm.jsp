		  ...
		  <table class="table table-striped table-hover">
		    ...
		    <tbody>
		        <tr>
		          ...
		          <c:if test="${lastScript == 0 }">
		          <td class="text-center">否</td>
		          </c:if>
		          <c:if test="${lastScript == 1 }">
      ...
      <div class="panel-footer">
	      <center>
		      <div class="btn-group" id="input" style="margin:5px;">
		        ...
		        <input type="button" class="btn btn-default" value="返回" onClick="${pageContext.request.contextPath}/main/myStudentScript!findMyStudents.action"/>
		      </div>   
	      </center>   
      </div>
      </form>
