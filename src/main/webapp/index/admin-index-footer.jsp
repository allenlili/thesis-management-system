      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="${pageContext.request.contextPath}/me/me!toUpdateTeaInfo.action"><i class="icon-user-md"></i>个人信息</a></li>
            <li class="divider"></li>
            <li><a href="${pageContext.request.contextPath}/me/me!toModifyTeaUserInfo.action"><i class="icon-lock"></i>密码设置</a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/process/task!findPage.action"><i class="icon-bullhorn"></i>我的待办任务</a></li>
