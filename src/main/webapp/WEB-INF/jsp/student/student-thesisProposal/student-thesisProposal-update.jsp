  ...
  <div class="container">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <p><span class="glyphicon glyphicon-arrow-right"></span><strong>修改开题报告</strong></p>
        <!--start修改内容 -->
        <form action="${pageContext.request.contextPath}/main/thesisProposal!update.action" method="post">      
	    <s:hidden name="id"></s:hidden>
        <div class="row" style="margin:5px;">
          <label class="">一、研究的现状及其意义</label>
          <div class="col-xs-12">
	        <div class="input-group">
			  <s:textarea name="firstContent" cssClass="form-control" rows="5" cols="200"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          ...
          <div class="col-xs-12">
	        <div class="input-group">
			  <s:textarea name="secondContent" cssClass="form-control" rows="5" cols="200"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          ...
          <div class="col-xs-12">
	        <div class="input-group">
			  <s:textarea name="thirdContent" cssClass="form-control" rows="5" cols="200"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          ...
          <div class="col-xs-12">
	        <div class="input-group">
			  <s:textarea name="fourthContent" cssClass="form-control" rows="5" cols="200"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
