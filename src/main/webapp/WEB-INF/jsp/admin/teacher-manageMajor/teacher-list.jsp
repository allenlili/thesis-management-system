...
<div id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading">
	  <h3 class="panel-title"><span class="glyphicon glyphicon-list-alt"></span><strong>确定评阅关系</strong></h3>		
	</div>
    ...
    <div class="panel-body">
      ...
      <form id="queryForm" action="${pageContext.request.contextPath}/manageMajor/teacher!findPage.action" method="post">
      <div class="row">
        <div class="col-xs-6">
      ...
      <!-- start删除内容-->
<%--       <form action="${pageContext.request.contextPath }/manageMajor/teacher!delete.action">   	    --%>
      <div id="execute">
        <input type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath }/manageMajor/teacher!toAdd.action'" value="添加教工">
...
<!-- 	        <th class="text-center"><input type="checkbox" id="checkboxes" value="checkbox0"/></th> -->
	        ...
	        <th class="text-center">对应评阅老师</th>
...
<%-- 	          <td class="text-center"><input type="checkbox" name="ids" class="singleCheckbox" value="${o.id }"/></td> --%>
			  ...
			  <c:if test="${o.viewer != null }">
			  <td class="text-center">${o.viewer.name }</td>
			  </c:if>
			  <c:if test="${o.viewer == null }">
			  <td class="text-center">未设置</td>
			  </c:if>			  
	          <td class="text-center">
	            <a href="${pageContext.request.contextPath}/manageMajor/teacher!toUpdate.action?id=${o.id}">修改</a>
	          </td>
	        </tr>
	      </c:forEach>    
	    </tbody>
...
<%-- 	    <form action="${pageContext.request.contextPath}/manageMajor/teacher!uploadTeaInfo.action" method="post" enctype="multipart/form-data"> --%>
