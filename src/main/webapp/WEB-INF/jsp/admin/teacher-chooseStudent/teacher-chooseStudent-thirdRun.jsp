...
<div id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading">
	  <h3 class="panel-title">
	    <span class="glyphicon glyphicon-list-alt"></span><strong>第三轮已选学生</strong>
    ...
    <div class="table-responsive">
	  <table class="table table-striped table-hover" id="deleteTable">
	   ...
	   <caption class="caption alert-danger text-muted"><span class="icon-hand-right"></span>Tips:您未在第三轮选择学生。</caption>
	   </c:if>		  
	    <thead>
	      <tr>
	        <c:if test="${myselfTeacher.chooseStudentRunNum == '2' }">
	    ...
	    <tbody>	    
	      <c:forEach items="${studentSelectedByMe}" var="o">
	        <tr>
	          <c:if test="${myselfTeacher.chooseStudentRunNum == '2' }">
	          <input type="hidden" name="uuids" class="singleCheckbox" value="${o.uuid }">
	          </c:if>
  ...
  <c:if test="${myselfTeacher.chooseStudentRunNum == '4' }">
   <center>
    <div class="btn-group" id="input">
      <input type="button" class="btn btn-default btn-lg" value="点击确认您的所有三轮选择" 
  ...
  <div class="panel panel-default">
  	<!--头部-->
    <div class="panel-heading">
	  <h3 class="panel-title"><span class="glyphicon glyphicon-list-alt"></span><strong>第三轮未选学生</strong></h3>		
	</div>
