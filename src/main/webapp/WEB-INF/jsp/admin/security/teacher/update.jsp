  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
      	<!--start修改内容 -->
      	<form action="${pageContext.request.contextPath}/security/teacher!update.action" method="post">
        ...
        <div class="btn-group" id="input">
          ...
          onClick="location.href='${pageContext.request.contextPath}/security/teacher!findPage.action'"/>
        </div>
        </center>
        </form>      
       <!--end 修改内容   -->
...
<%-- 				  <c:forEach items="${institute}" var="o"> --%>
				    <tr>
			          ...
			          <td class="text-center">
			            <input type="button" class="btn" onclick="location.href='${pageContext.request.contextPath }/security/teacher!deleteInstitute.action?id=${id }&instituteId=${institute.id }'" value="删除">
			          </td>
				    </tr>
<%-- 				  </c:forEach> --%>
				  <!-- 增加行 -->
				  <form action="${pageContext.request.contextPath }/security/teacher!addInstitute.action" method="post">
				    <s:hidden name="id"></s:hidden>
					<tr>
			          <td class="text-center">
			    ...
			    <tbody>
				  ...
				  <c:forEach items="${majors}" var="m">
				    <tr>
			          ...
			          <td class="text-center">
			            <input type="button" class="btn" onclick="location.href='${pageContext.request.contextPath }/security/teacher!deleteMajor.action?id=${id }&majorId=${m.id }'" value="删除">
			          </td>
				    </tr>
				  </c:forEach>
				  <!-- 增加行 -->
				  <form action="${pageContext.request.contextPath }/security/teacher!addMajor.action" method="post">
				    <s:hidden name="id"></s:hidden>
					<tr>
			          <td class="text-center">
