    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<div class="form-group">        
            <p><span class="glyphicon glyphicon-arrow-right"></span><strong>修改资源</strong></p>
            <div class="input-group" id="input">
              <span class="input-group-addon">访问地址</span>
              <input name="url" type="text" class="form-control" placeholder="学号或者工号" value="${url }">
            </div>
	        <center>
				  ...
				  <c:forEach items="${roles}" var="o">
				    <tr>
			          ...
			          <td class="text-center">
			            <input type="button" class="btn" onclick="location.href='${pageContext.request.contextPath }/security/resource!deleteRole.action?id=${id }&roleId=${o.id }'" value="删除">
			          </td>
				    </tr>
				  </c:forEach>
				  <!-- 增加行 -->
				  <form action="${pageContext.request.contextPath }/security/resource!addRole.action" method="post">
				    <s:hidden name="id"></s:hidden>
					<tr>
