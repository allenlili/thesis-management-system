    ...
    <div class="panel panel-default">
      ...
      <form  action="${pageContext.request.contextPath}/process/definition!deploy.action" method="post" enctype="multipart/form-data">      
        <div class="form-group">
          <p><span class="glyphicon glyphicon-arrow-right"></span><strong>发布流程定义</strong></p>
        
          <div class="input-group" id="input">
            <span class="input-group-addon">流程定义文件</span>
            <input name="process" type="file" class="form-control">
          </div>
        
          <center>
          <div class="btn-group" id="input">
            <input type="submit" class="btn btn-default" value="发布流程定义"/>
