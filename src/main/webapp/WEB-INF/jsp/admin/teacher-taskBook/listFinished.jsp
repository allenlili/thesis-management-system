...
<div id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading">
	  <h3 class="panel-title"><span class="glyphicon glyphicon-list-alt"></span><strong>任务书管理</strong>-审批结束（历史记录）</h3>		
	</div>
    ...
    <div class="panel-body">
      ...
      <form id="queryForm" action="${pageContext.request.contextPath}/main/taskBookFinished!findPage.action" method="post">
...
<!--         </div>                 -->
      ...
      <!-- start删除内容-->
      <form id="performForm" action="${pageContext.request.contextPath }/main/taskBookFinished!delete.action">
	      ...
	      <c:forEach items="${page.result}" var="o">
	        <tr>
	          ...
	          <td class="text-center">
	            <a href="${pageContext.request.contextPath }/main/taskBookFinished!watch.action?id=${o.id}&definitionKey=<s:property value='@com.zhbit.core.utils.EnumStatus.ProcessEnum@taskBook'/>">查看</a>
	          </td>	          
	        </tr>
	      </c:forEach>    
	    </tbody>
