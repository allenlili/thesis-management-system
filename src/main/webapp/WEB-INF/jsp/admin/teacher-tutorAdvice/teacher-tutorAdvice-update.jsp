...
<div id="main-content">
  <div class="container">
    ...
    <div class="panel panel-default">
      ...
      <!--start增加内容 -->
      <form  action="${pageContext.request.contextPath}/main/tutorAdvice!update.action" method="post" enctype="multipart/form-data">      
        <s:hidden name="id"></s:hidden>
        <div class="form-group">
          <p><span class="glyphicon glyphicon-arrow-right"></span><strong>修改指导意见表</strong></p>
        
          <div class="input-group" id="input">
            <span class="input-group-addon">指导分数</span>
            <input id="tutorGrade" name="tutorGrade" type="text" class="form-control" value="${tutorGrade }">
          </div>
