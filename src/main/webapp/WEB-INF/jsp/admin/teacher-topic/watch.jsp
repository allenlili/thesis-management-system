...
<div id="main-content">
  <div class="container">
    ...
    <div class="panel panel-default">
      ...
      <p><span class="glyphicon glyphicon-arrow-right"></span><strong>查看题目</strong></p>
      <!--start修改内容 -->
	      <div class="row" style="margin:5px;">
	        <div class="col-xs-4">
		      <div class="input-group">
		        <span class="input-group-addon">题目名称</span>
		        <input type="text" class="form-control" name="topicName" value="${topicName }" readonly="readonly">
		      </div>                  
	        </div>
	        <div class="col-xs-4">
		      <div class="input-group">
