...
function startProcess() {
	$('#performForm').attr('action', '${pageContext.request.contextPath }/main/topic!start.action');
	$('#performForm').submit();
}
</script>
</head>
...
<div id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading">
	  <h3 class="panel-title"><span class="glyphicon glyphicon-list-alt"></span><strong>选题管理</strong>-未审批</h3>		
	</div>
    ...
    <div class="panel-body">
      ...
      <form id="queryForm" action="${pageContext.request.contextPath}/main/topic!findPage.action" method="post">
...
<!--         </div>                 -->
      ...
      <!-- start删除内容-->
      <form id="performForm" action="${pageContext.request.contextPath }/main/topic!delete.action">   	   
      <s:hidden name="definitionKey" value="%{@com.zhbit.core.utils.EnumStatus.ProcessEnum@topic}"></s:hidden>
      <div id="execute">
        <input type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath }/main/topic!toAdd.action'" value="添加题目">
	    ...
	    <tbody>
	      <c:forEach items="${page.result}" var="o">
	        <tr>
	          ...
	          <td class="text-center"><a href="${pageContext.request.contextPath}/main/topic!toUpdate.action?id=${o.id}">修改</a></td>	          
	        </tr>
	      </c:forEach>    
	    </tbody>
	  </table>
