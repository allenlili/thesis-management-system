    ...
    <div class="panel panel-default">
      ...
      <!--start增加内容 -->
        <div class="form-group">
          <p><span class="glyphicon glyphicon-arrow-right"></span><strong>查看评阅意见表</strong></p>
        
          <div class="input-group" id="input">
            <span class="input-group-addon">评阅分数</span>
            <input name="viewerGrade" type="text" class="form-control" readonly="readonly" value="${viewerGrade }">
          </div>
		  ...
		  <div class="row" style="margin:5px;">
		    ...
		    <div class="col-xs-12">
		      <div class="input-group">
		        <s:textarea name="opinion" cssClass="form-control" rows="5" cols="200" placeholder='请给出评阅意见！' readonly="true" style="resize:none;"></s:textarea>
		      </div>                  
		    </div>
		  </div> 
