...
<div id="main-content">
  <div class="container">
    ...
    <div class="panel panel-default">
      ...
      <!--start增加内容 -->
      <form  action="${pageContext.request.contextPath}/main/viewerAdvice!save.action" method="post" enctype="multipart/form-data">      
        <s:hidden name="studentUuid"></s:hidden>
        <div class="form-group">
          <p><span class="glyphicon glyphicon-arrow-right"></span><strong>创建评阅意见表</strong></p>
        
          <div class="input-group" id="input">
            <span class="input-group-addon">评阅分数</span>
            <input id="viewerGrade" name="viewerGrade" type="text" class="form-control">
          </div>
