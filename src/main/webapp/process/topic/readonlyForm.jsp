	      ...
	      <div class="row" style="margin:5px;">
	        <div class="col-xs-4">
		      <div class="input-group">
		        ...
		        <input type="text" class="form-control"  value="${topicName }" readonly="readonly">
		      </div>                  
	        </div>
	        <div class="col-xs-4">
		      <div class="input-group">
	        ...
	        <div class="col-xs-4">
		      <div class="input-group">
		        ...
		        <input type="text" class="form-control"  value="${origin }" readonly="readonly">
		      </div>                 
	        </div>	      
	      </div>
	      <div class="row" style="margin:5px;">
	        <div class="col-xs-4">
		      <div class="input-group">
		        ...
		        <input type="text" class="form-control"  value="${level }" readonly="readonly">
		      </div>                  
	        </div>
	        <div class="col-xs-4">
		      <div class="input-group">
		        <span class="input-group-addon">题目性质</span>
		        <input type="text" class="form-control"  value="${quality }" readonly="readonly">
		      </div>                  
	        </div>
	        <div class="col-xs-4">
		      <div class="input-group">
		        <span class="input-group-addon">是否新题</span>
		        <input type="text" class="form-control"  value="${oldOrNew }" readonly="readonly">
		      </div>                  
	        </div>
	      </div>
	      <div class="row" style="margin:5px;">
