...
<div id="main-content">
  <div class="container">
    ...
    <div class="panel panel-default">
      ...
      <!--主体-->
      <form action="${pageContext.request.contextPath}/main/thesisProposal!performTask.action" method="post">
      <s:hidden name="taskId" value="%{#parameters.taskId}"></s:hidden>
      <s:hidden name="id"></s:hidden>            
      <div class="panel-body">
      <p><span class="glyphicon glyphicon-arrow-right"></span><strong>查看任务书</strong></p>
      <!--start查看内容 -->
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
		      <label class="">一、研究的现状及其意义</label>
			  <s:textarea name="firstContent" cssClass="form-control" rows="5" cssStyle="resize:none;" readonly="true"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="secondContent" cssClass="form-control" rows="5" cssStyle="resize:none;" readonly="true"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="thirdContent" cssClass="form-control" rows="5" cssStyle="resize:none;" readonly="true"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="fourthContent" cssClass="form-control" rows="5" cssStyle="resize:none;" readonly="true"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="fifithContent" cssClass="form-control" rows="5" cssStyle="resize:none;" readonly="true"></s:textarea>
	        </div>                  
          </div>
        </div>
	    <div class="row" style="margin:5px;">
