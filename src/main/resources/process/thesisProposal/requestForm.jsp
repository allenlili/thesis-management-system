        ...
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="thirdContent" cssClass="form-control" rows="5" cssStyle="resize:none;"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="fourthContent" cssClass="form-control" rows="5" cssStyle="resize:none;"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
          <div class="col-xs-12">
	        <div class="input-group">
			  ...
			  <s:textarea name="fifithContent" cssClass="form-control" rows="5" cssStyle="resize:none;"></s:textarea>
	        </div>                  
          </div>
        </div>
        <div class="row" style="margin:5px;">
      ...
      <div class="panel-footer">
	      ...
	      <div class="btn-group" id="input" style="margin:5px;">
	        <s:iterator value="#buttonList" var="v">
	          ...
	          <input type="button" class="btn btn-default" value="返回" onClick="location.href='#'"/>
	      </div>   
	      </center>       
      </div>
